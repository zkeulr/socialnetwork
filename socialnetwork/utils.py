...
def save_connections(dict, data_directory="data/connections.json", history_directory="history/"):
...
def save(fig, filename, output_directory="output/", history_directory="history/"):
    ...
    fig.write_image(os.path.join(output_directory, f"{filename}.png"), width=1920, height=1080, scale=2)
